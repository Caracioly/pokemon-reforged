...
function PokeHalfDamage({ relations }: DamageRelationsComponentProps) {
  return (
    <div className="text-center bg-fuchsia-900/50 p-0.5 rounded-md border-2 border-black w-full overflow-hidden">
...
function PokeQuarterDamage({ relations }: DamageRelationsComponentProps) {
  return (
    <div className="text-center bg-red-900/50 p-0.5 rounded-md border-2 border-black w-full overflow-hidden">
